# Accessibility for SnowRaven Mini
...
Wherever keyboard focus lands, you can see it. Focused controls show a clear green outline. It is a 2px ring offset slightly from the control, with a border-hugging ring on the key input fields, so you always know where you are in the popup or on the Options page.
