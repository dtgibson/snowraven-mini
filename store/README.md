# Store Submission Package: SnowRaven Mini v1.3.0
...
- Chrome: `artifacts/snowraven-mini-chrome-1.3.0.zip`
- Firefox: `artifacts/snowraven-mini-firefox-1.3.0.zip`
- Firefox source (required by AMO): `artifacts/snowraven-mini-source-1.3.0.zip` (build steps in `/BUILD.md`)

## Key facts
- Both stores ship v1.3.0 from one build. Chrome ignores the manifest `gecko` block; Firefox reads it.
