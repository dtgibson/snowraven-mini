...
Both the **Chrome Web Store** and **Firefox Add-ons** are live at **v1.3.0** — full cross-store parity — and the site and its custom domain are live. The walkthrough and combined copy shipped in **v1.3.0** (55d501b).
