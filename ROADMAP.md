...
The **Chrome Web Store** and **Firefox Add-ons** listings are live (serving v1.2.0), and the site and its custom domain are live (now showing v1.3.0). The walkthrough and combined copy shipped in **v1.3.0** (released on GitHub, 55d501b); the stores are updating from v1.2.0 to v1.3.0.
